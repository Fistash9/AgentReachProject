...
- chuzom-router — НЕ ПЕРЕВІРЕНО. На npm 404 Not Found
  (перевірено 2026-09-18). Раніше стверджувалось, що це той самий
  проект, що llm-routing — джерело невідоме, не підтверджено.
