...
- **llm-cost-router-mcp** — MCP для cost-awareness (радить, яка модель дешевша, без ключів).
  version 0.3.0, npm, Node.js, `@modelcontextprotocol/sdk` `^1.0.0`.
  Немає конфлікту з agent-reach (JS SDK vs Python pip `mcp<2.0.0`).
  Перевірено 2026-09-18, готовий до встановлення.
