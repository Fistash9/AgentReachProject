...
## Оновлення 2026-09-24 (друга і третя сесії)

### Статус змінився
- `claude-anthropic.sh` — НЕ потрібен, пункт закрито (a008ff1): пункт 3
  menu.sh уже йде на Anthropic, Opus 5.5 типова.
- Мислення DeepSeek — рішення ухвалено: лишити як є (dfed51e); штатно
  вимкнути не можна, проксі не будуємо.

### Зроблено
- Стартове навантаження виміряно: 48 681 ток. до першої дії, 65 324 після
  baton_pick_up (baton ≈16k). MCP-схеми на старті не вантажаться.
- Задум baton з'ясовано (RULES-WHY.md «Baton — передача контексту»):
  розростання — наше використання однієї естафети на всі теми, не баг.
- claude-setup (обидва) — не аудитори; кандидати-аудитори й інструменти
  пам'яті між сесіями — BACKLOG.md.

### Поточний фокус (оновлення 2026-09-24, третя сесія)
