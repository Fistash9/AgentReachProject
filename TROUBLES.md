...
## Урок: невірифіковані твердження в BACKLOG (2026-09-18)
- Твердження "chuzom-router = llm-routing" потрапило в BACKLOG
  без перевірки (джерело: рекомендація AI, не підтверджена)
- Правило: перед записом факту в BACKLOG — верифікувати
- Позначати "НЕ ПЕРЕВІРЕНО" якщо джерело невідоме
